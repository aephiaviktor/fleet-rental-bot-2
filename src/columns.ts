...
export const COLUMN_DEFINITIONS: readonly ColumnDefinition[] = [
  ...
  { id: 'rentalCost', label: 'Estimated rental cost / day', group: 'economics', defaultVisible: true },
  { id: 'operatingValue', label: 'Estimated operating value / day', group: 'economics', defaultVisible: true },
  { id: 'netValue', label: 'Estimated net value / day', group: 'economics', defaultVisible: true },
